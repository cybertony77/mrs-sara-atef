        ...
        try {
          ...
          if (element.tagName.toLowerCase() === 'canvas') {
            ...
            if (container) {
              ...
              gradient.addColorStop(0, '#d65fa0');
              gradient.addColorStop(1, '#3fbbd4');
    ...
    <div style={{ 
      ...
      <style jsx>{`
        ...
        .hidden-qr .qr-container {
          background: linear-gradient(130deg,rgba(209, 96, 158, 1) 0%, #3fbbd4 100%);
          padding: 10px;
          border-radius: 20px;
          overflow: hidden;
          display: flex;
            ...
            <div className="qr-center-wrapper">
              <div className="qr-display">
                <div className="qr-container">
                  <QRCode
                    id="single-qr-svg"
                    value={`https://linktr.ee/sara.atef/?id=${singleId}`}
                    size={qrSize}
                    ecLevel="H"
                    logoImage="/logo.png"
                    logoWidth={logoSize}
          ...
          <div className="hidden-qr">
            {qrIds.map((id) => (
              <div className="qr-container" key={id}>
                <QRCode
                  id={`hidden-qr-${id}`}
                  value={`https://linktr.ee/sara.atef/?id=${id}`}
                  size={qrSize}
                  ecLevel="H"
                  logoImage="/logo.png"
                  logoWidth={logoSize}
